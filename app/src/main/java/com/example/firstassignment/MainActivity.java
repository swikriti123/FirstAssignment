...
//        Location Spinner Part
        ...
        final Spinner cDropDown = findViewById(R.id.spnCountry);
        String location [] = {"Select Country","Nepal","India","China" , "Bangladesh" , "Thailand"};
        ArrayAdapter adapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item,location);
        cDropDown.setAdapter(adapter);

//         Room Spinner Part


        final Spinner roomDropDown = findViewById(R.id.spnHotelType);
        String room [] = {"Select Room Type","Delux","Platinum", "Diamond"};
...
//        Check Out Part
        ...
        btnCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if(roomDropDown.getSelectedItem().toString() == "Platinum") {
                    txtRoom.setText("4000");
                } else  {
                    txtRoom.setText("7000");
                }
